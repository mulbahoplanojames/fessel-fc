...
const ClubNews: React.FC<AllNewsProps> = ({ filteredNews, clearSearch }) => {
  return (
    <>
      {filteredNews.length > 0 ? (
          ...
          {filteredNews.map((item) => (
            ...
            >
              ...
              <CardContent className="px-6 pb-4">
                <Badge className="mb-3 bg-primary-clr">Club News</Badge>
        ...
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground max-w-md mx-auto mb-6">
            We couldn&apos;t find any club news articles matching your search
            criteria.
          </p>
